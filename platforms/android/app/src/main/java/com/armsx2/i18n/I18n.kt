...
val EN: Map<String, String> = mapOf(
    ...
    "externalDisplay.pauseMenu" to "Pause Menu",
    "externalDisplay.playing" to "Playing on External Display",
    "externalDisplay.sending" to "Video output is being sent over HDMI.",
    ...
    "renderer.dedicatedExternal.description" to "Sends only the game image to a connected display. App-wide; ignored in Samsung DeX and Android desktop mode.",
    "renderer.dedicatedExternal.desktopIgnored" to "Enabled, but inactive while Samsung DeX or Android desktop mode is running.",
    "renderer.dedicatedExternal.label" to "Dedicated HDMI Output (Beta)",
