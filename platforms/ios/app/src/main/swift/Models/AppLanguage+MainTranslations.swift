...
extension AppLanguage {
    static let translations: [AppLanguage: [String: String]] = [
        .simplifiedChinese: [
            ...
            "Dedicated HDMI Output (Beta)": "专用 HDMI 输出 (Beta)",
            "Sends only the game image to a connected display. When unavailable or disabled, the iPhone uses normal display mirroring.": "仅将游戏画面发送到已连接的显示器。不可用或关闭时，iPhone 将使用正常的屏幕镜像。",
            "Playing on External Display": "正在外接显示器上播放",
            "Video output is being sent over HDMI.": "视频画面正在通过 HDMI 输出。",
            "Pause Menu": "暂停菜单",
            "Opens the pause menu": "打开暂停菜单",
            "Games": "游戏",
            "BIOS": "BIOS",
            "Help": "帮助",
            "Settings": "设置",
        ...
        .arabic: [
            ...
            "Dedicated HDMI Output (Beta)": "إخراج HDMI مخصص (Beta)",
            "Sends only the game image to a connected display. When unavailable or disabled, the iPhone uses normal display mirroring.": "يرسل صورة اللعبة فقط إلى شاشة متصلة. عند عدم توفره أو تعطيله، يستخدم iPhone انعكاس الشاشة العادي.",
            "Playing on External Display": "يتم العرض على شاشة خارجية",
            "Video output is being sent over HDMI.": "يتم إرسال إخراج الفيديو عبر HDMI.",
            "Pause Menu": "قائمة الإيقاف المؤقت",
            "Opens the pause menu": "يفتح قائمة الإيقاف المؤقت",
            "Games": "الألعاب",
            "BIOS": "BIOS",
            "Help": "مساعدة",
            "Settings": "الإعدادات",
            ...
            "Show Viewport": "إظهار منفذ العرض",
        ...
        .spanish: [
            ...
            "Dedicated HDMI Output (Beta)": "Salida HDMI dedicada (Beta)",
            "Sends only the game image to a connected display. When unavailable or disabled, the iPhone uses normal display mirroring.": "Envía solo la imagen del juego a una pantalla conectada. Cuando no está disponible o está desactivada, el iPhone usa la duplicación de pantalla normal.",
            "Playing on External Display": "Reproduciendo en la pantalla externa",
            "Video output is being sent over HDMI.": "La señal de vídeo se está enviando por HDMI.",
            "Pause Menu": "Menú de pausa",
            "Opens the pause menu": "Abre el menú de pausa",
            "Games": "Juegos",
            "BIOS": "BIOS",
            "Help": "Ayuda",
            "Settings": "Ajustes",
            ...
            "Show Viewport": "Mostrar área de visualización",
        ...
        .french: [
            ...
            "Dedicated HDMI Output (Beta)": "Sortie HDMI dédiée (Beta)",
            "Sends only the game image to a connected display. When unavailable or disabled, the iPhone uses normal display mirroring.": "Envoie uniquement l’image du jeu vers un écran connecté. Lorsqu’elle est indisponible ou désactivée, l’iPhone utilise la recopie d’écran normale.",
            "Playing on External Display": "Lecture sur l’écran externe",
            "Video output is being sent over HDMI.": "La sortie vidéo est transmise via HDMI.",
            "Pause Menu": "Menu pause",
            "Opens the pause menu": "Ouvre le menu pause",
            "Games": "Jeux",
            "BIOS": "BIOS",
            "Help": "Aide",
            "Settings": "Réglages",
            ...
            "Show Viewport": "Afficher la zone d’affichage",
        ...
        .german: [
            ...
            "Dedicated HDMI Output (Beta)": "Dedizierte HDMI-Ausgabe (Beta)",
            "Sends only the game image to a connected display. When unavailable or disabled, the iPhone uses normal display mirroring.": "Sendet nur das Spielbild an einen angeschlossenen Bildschirm. Wenn die Funktion nicht verfügbar oder deaktiviert ist, verwendet das iPhone die normale Bildschirmsynchronisierung.",
            "Playing on External Display": "Wiedergabe auf externem Bildschirm",
            "Video output is being sent over HDMI.": "Die Videoausgabe wird über HDMI übertragen.",
            "Pause Menu": "Pausenmenü",
            "Opens the pause menu": "Öffnet das Pausenmenü",
            "Games": "Spiele",
            "BIOS": "BIOS",
            "Help": "Hilfe",
            ...
            "Show Viewport": "Viewport anzeigen",
        ...
        .italian: [
            ...
            "Dedicated HDMI Output (Beta)": "Uscita HDMI dedicata (Beta)",
            "Sends only the game image to a connected display. When unavailable or disabled, the iPhone uses normal display mirroring.": "Invia solo l’immagine del gioco a uno schermo collegato. Quando non è disponibile o è disattivata, l’iPhone usa la normale duplicazione dello schermo.",
            "Playing on External Display": "Riproduzione sullo schermo esterno",
            "Video output is being sent over HDMI.": "L’uscita video viene inviata tramite HDMI.",
            "Pause Menu": "Menu di pausa",
            "Opens the pause menu": "Apre il menu di pausa",
            "Games": "Giochi",
            "BIOS": "BIOS",
            "Help": "Aiuto",
        ...
        .portuguese: [
            ...
            "Dedicated HDMI Output (Beta)": "Saída HDMI dedicada (Beta)",
            "Sends only the game image to a connected display. When unavailable or disabled, the iPhone uses normal display mirroring.": "Envia somente a imagem do jogo para uma tela conectada. Quando indisponível ou desativada, o iPhone usa o espelhamento de tela normal.",
            "Playing on External Display": "Reproduzindo na tela externa",
            "Video output is being sent over HDMI.": "A saída de vídeo está sendo enviada por HDMI.",
            "Pause Menu": "Menu de pausa",
            "Opens the pause menu": "Abre o menu de pausa",
            "Games": "Jogos",
            "BIOS": "BIOS",
            "Help": "Ajuda",
            ...
            "Show CPU": "Mostrar CPU",
            "Show GPU": "Mostrar GPU",
            "Show Viewport": "Mostrar viewport",
        ...
        .japanese: [
            ...
            "Dedicated HDMI Output (Beta)": "専用 HDMI 出力 (Beta)",
            "Sends only the game image to a connected display. When unavailable or disabled, the iPhone uses normal display mirroring.": "ゲーム映像のみを接続されたディスプレイに出力します。利用できない場合や無効な場合、iPhone は通常の画面ミラーリングを使用します。",
            "Playing on External Display": "外部ディスプレイで再生中",
            "Video output is being sent over HDMI.": "映像を HDMI 経由で出力しています。",
            "Pause Menu": "ポーズメニュー",
            "Opens the pause menu": "ポーズメニューを開きます",
            "Games": "ゲーム",
            "BIOS": "BIOS",
            "Help": "ヘルプ",
            "Settings": "設定",
        ...
        .korean: [
            ...
            "Dedicated HDMI Output (Beta)": "전용 HDMI 출력 (Beta)",
            "Sends only the game image to a connected display. When unavailable or disabled, the iPhone uses normal display mirroring.": "게임 화면만 연결된 디스플레이로 보냅니다. 사용할 수 없거나 비활성화된 경우 iPhone은 일반 화면 미러링을 사용합니다.",
            "Playing on External Display": "외부 디스플레이에서 재생 중",
            "Video output is being sent over HDMI.": "비디오가 HDMI를 통해 출력되고 있습니다.",
            "Pause Menu": "일시 정지 메뉴",
            "Opens the pause menu": "일시 정지 메뉴를 엽니다",
            "Games": "게임",
            "BIOS": "BIOS",
            "Help": "도움말",
            "Settings": "설정",
